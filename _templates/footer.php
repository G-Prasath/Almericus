...
<div class="relative">
    <!-- Background Image -->
    <img src="./imgs/b2.jpg" alt="Footer Background" class="absolute inset-0 w-full h-full object-cover object-center z-0" />
    <!-- Black Overlay -->
    <div class="absolute inset-0 bg-black opacity-70 z-0"></div>

    <div class="relative px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 z-10 text-white">
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="sm:col-span-2">
                <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                   <img src="./imgs/logo.png" style="width:250px" alt="">
                </a>
            ...
            <div>
                ...
                <div class="flex items-center mt-1 space-x-3">
                    <a href="/" class="text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400">
        ...
        <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-white lg:flex-row">
            <p class="text-sm text-gray-300">
                &copy; Copyright 2025 Almericus. All rights reserved.
            </p>
